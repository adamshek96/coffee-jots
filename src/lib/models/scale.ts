...
export function buildScale(beanColor = "#8E9B6B", unit = "g", hot = false): THREE.Group {
  ...
  const seed = [
    ...
    // heaps it to the rim. Five loose courses, each offset off the one under it
    // so the gaps never line up into a grid.
    [-0.15, 0.075, 0.02], [-0.08, 0.075, -0.13], [0.03, 0.075, -0.15], [0.14, 0.075, -0.06],
    [0.16, 0.075, 0.08], [0.07, 0.075, 0.16], [-0.05, 0.075, 0.15], [-0.16, 0.075, -0.08],

    [-0.11, 0.108, -0.05], [0.0, 0.108, -0.12], [0.11, 0.108, -0.08], [0.15, 0.108, 0.03],
    [0.09, 0.108, 0.13], [-0.02, 0.108, 0.14], [-0.13, 0.108, 0.09], [-0.17, 0.108, 0.0],

    [-0.14, 0.14, 0.06], [-0.07, 0.14, -0.1], [0.05, 0.14, -0.13], [0.14, 0.14, -0.02],
    [0.12, 0.14, 0.1], [0.01, 0.14, 0.15], [-0.09, 0.14, 0.12], [-0.03, 0.14, -0.02],

    [-0.1, 0.172, -0.02], [0.0, 0.172, -0.1], [0.09, 0.172, -0.04], [0.11, 0.172, 0.07],
    [0.02, 0.172, 0.11], [-0.08, 0.172, 0.08], [-0.02, 0.172, 0.0],

    [-0.05, 0.198, 0.02], [0.05, 0.198, 0.04], [0.0, 0.198, -0.06], [0.08, 0.198, -0.03],
    [-0.03, 0.198, 0.09],
  ];
